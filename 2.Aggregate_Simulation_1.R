...
# Get the names of the files in the directory for the first simulation (note file 1 is parameter data)
files<-dir("Output_Simulation_1")[-1]
...
# If there are multiple instanes run, get those and aggregate them too
if(length(files) > 1){
...
save(lnRR_long, file="Aggregate_Data/long_lnRR_simulation_1.Rdata")
save(lnCV_long, file="Aggregate_Data/long_lnCV_simulation_1.Rdata")
...
save(agg_results, file="Aggregate_Data/agg_results_simulation_1.Rdata")
