...
files<-dir("Output_Simulation_3")[-1]
...
save(lnRR_long, file="Aggregate_Data/long_lnRR_simulation_3.Rdata")
save(lnCV_long, file="Aggregate_Data/long_lnCV_simulation_3.Rdata")
...
save(agg_results, file="Aggregate_Data/agg_results_simulation_3.Rdata")
