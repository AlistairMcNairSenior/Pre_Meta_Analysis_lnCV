...
if(index == 1){
	if(dir.exists("Output_Simulation_1")){
		dir_delete("Output_Simulation_1")
	}
	dir.create("Output_Simulation_1")	
}
...
save(results, file=paste0("Output_Simulation_1/Simulation_1_", index, ".Rdata"))
save(parameters, file="Output_Simulation_1/Parameters_Simulation_1.Rdata")
