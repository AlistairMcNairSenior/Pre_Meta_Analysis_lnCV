...
if(index == 1){
	if(dir.exists("Output_Simulation_2")){
		dir_delete("Output_Simulation_2")
	}
	dir.create("Output_Simulation_2")	
}
...
save(results, file=paste0("Output_Simulation_2/Simulation_2_", index, ".Rdata"))
save(parameters, file="Output_Simulation_2/Parameters_Simulation_2.Rdata")
