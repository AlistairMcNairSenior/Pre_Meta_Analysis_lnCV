...
files<-dir("Output_Simulation_2")[-1]
...
# Save that
save(lnRR_long, file="Aggregate_Data/long_lnRR_simulation_2.Rdata")
save(lnCV_long, file="Aggregate_Data/long_lnCV_simulation_2.Rdata")
...
save(agg_results, file="Aggregate_Data/agg_results_simulation_2.Rdata")
