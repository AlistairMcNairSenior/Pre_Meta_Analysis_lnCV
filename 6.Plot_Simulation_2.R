...
# This script creates a figure for the complete set of all simlulation parameters explored in the second simulation.
...
# Load the results
load("Aggregate_Data/agg_results_simulation_2.Rdata")
